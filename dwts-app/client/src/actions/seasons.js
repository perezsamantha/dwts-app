...
export const addSeason = (season) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ type: actionType.SEASONADD_FAILURE, payload: error, error: true });
    }
}
...
export const findSeasonById = (id) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ type: actionType.SEASONFIND_FAILURE, payload: error, error: true });
    }
}
...
export const deleteSeason = (id) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ type: actionType.SEASONDELETE_FAILURE, payload: error, error: true });
    }
}
