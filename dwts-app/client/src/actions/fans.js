...
export const addUser = (user) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ type: actionType.USERADD_FAILURE, payload: error, error: true });
    }
}
...
export const findUserById = (id) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ type: actionType.USERFIND_FAILURE, payload: error, error: true });
    }
}
...
export const fetchUsers = () => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ type: actionType.USERSEARCH_SUCCESS, payload: { users: users.data, seasons: seasons.data } });
    } catch (error) {
        dispatch({ type: actionType.USERSEARCH_FAILURE, payload: error, error: true });
    }
}
...
export const updateUser = (id, user) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ type: actionType.USERUPDATE_FAILURE, payload: error, error: true });
    }
}
...
export const deleteUser = (id) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ type: actionType.USERDELETE_FAILURE, payload: error, error: true });
    }
}