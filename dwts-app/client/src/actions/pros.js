...
export const addPro = (pro) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ type: actionType.PROADD_FAILURE, payload: error, error: true });
    }
}
...
export const deletePro = (id) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ type: actionType.PRODELETE_FAILURE, payload: error, error: true });
    }
}
...
export const likePro = (id) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({ type: actionType.PROLIKE_FAILURE, payload: error, error: true });
    }
}
