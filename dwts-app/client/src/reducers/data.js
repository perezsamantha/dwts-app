...
const dataReducer = (state = {
    ...
    switch (action.type) {
        ...
        case actionType.TEAMUPDATE_SUCCESS:
            return { ...state, teams: [...state.teams.map(team => team.id === action.payload.id ? action.payload : team)], team: action.payload.team }
        ...
        case actionType.TEAMFIND_SUCCESS:
            return { ...state, team: action.payload.team, celebs: action.payload.celebs, pros: action.payload.pros, seasons: action.payload.seasons };
