...
export const updateSeason = async (req, res) => {
    ...
    try {
        const result = await pool.query('UPDATE seasons SET number = $1, extra = $2 WHERE id = $3 RETURNING *', [number, extra, id]);
...
export const setSeasonPic = async (req, res) => {
    ...
    try {
        ...
        blobWriter.on('finish', async () => {
            ...
            const result = await pool.query('UPDATE seasons SET cover_pic = $1 WHERE id = $2 RETURNING *', [publicUrl, req.params.id]);
