...
export const addCeleb = async (req, res) => {
    try {
        ...
        const result = await pool.query(`INSERT INTO celebs (first_name, last_name, birthday, height, gender, twitter, instagram, tiktok, is_junior) VALUES($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING *`, [first_name, last_name, birthday, height, gender, twitter, instagram, tiktok, is_junior]);
...
export const fetchAllCelebs = async (req, res) => {
    try {
        const celebs = await pool.query('SELECT * FROM celebs');
...
// export const searchcelebs = async (req, res) => {
//     const { search } = req.body;

//     try {
//         const celebs = await pool.query("SELECT * FROM celebs WHERE ___ ILIKE $1", [`%${search}%`]);
