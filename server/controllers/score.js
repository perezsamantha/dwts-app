...
export const addScore = async (req, res) => {
    try {
        ...
        const result = await pool.query(`INSERT INTO scores (dance_id, judge_id, value, "order", is_guest) VALUES($1, $2, $3, $4, $5) RETURNING *`, [dance_id, judge_id, value, order, is_guest]);
...
export const findScoreById = async (req, res) => {
    ...
    try {
        const score = await pool.query('SELECT * FROM scores WHERE id = $1', [id]);
...
export const updateScore = async (req, res) => {
    ...
    try {
        ...
        const result = await pool.query('UPDATE scores SET dance_id = $1, judge_id = $2, value = $3, "order" = $4, is_guest = $5 WHERE id = $6 RETURNING *', [dance_id, judge_id, value, order, is_guest, id]);
